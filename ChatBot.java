...
public class ChatBot extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if(message.contains("what") && message.contains("name"))
		{
			...
			{
				bot("I'm Enzo your computer assistance...");
			}
			if(message.contains("my"))
			{
				bot("Sir your name is Mayur Pimpude");
			}
		}
		...
		else if(message.contains("open") && message.contains("gmail"))
		{
			try
			{
			URL gurl = new URL("https://accounts.google.com");
			URLConnection gconnection = gurl.openConnection();
			gconnection.connect();
			bot("Opening Gmail Sir.");
			java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://mail.google.com/mail/u/0/#inbox"));
			}
			catch(Exception ee)
				{
		...
		else if(message.contains("open") && message.contains("youtube"))
		{
			try
			{
			URL yurl = new URL("https://accounts.google.com");
			URLConnection yconnection = yurl.openConnection();
			yconnection.connect();
			bot("Yes Iniaiting YouTube Sir.");
		...
		else if(message.contains("play"))
		{
			try
			{
			URL ypurl = new URL("https://accounts.google.com");
			URLConnection ypconnection = ypurl.openConnection();
			ypconnection.connect();
			bot("Hope Youtube is open Sir.");
			java.awt.Desktop.getDesktop().browse(java.net.URI.create("https://www.youtube.com/results?search_query="+message.replace(" ","+")));
			}
			catch(Exception ee)
				{
					bot("Connect with internet connection for get better results...");
